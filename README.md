...
**팀이 자기 Slack 앱·자기 토큰·자기 컴퓨터로 돌립니다.** 밖으로 나가는 것은 둘뿐입니다 — 정리할 메시지는 Claude(Anthropic)로,
회의 일정은 연결한 구글 캘린더로. 자세히는 [`PRIVACY.md`](PRIVACY.md).
...
회의: DM 「회의 만들자」 → ① 이름 ② 프로젝트 ③ 한 번/정기 ④ 언제 ⑤ 누구를(@사람 · 모두 · 나만)
      → #프로젝트-○○ 에 카드 · 구글 캘린더 「모아」 에 일정 + 초대 · 10분 전 알림 · [✍️ 논의 적기] → 📝 회의록
```
